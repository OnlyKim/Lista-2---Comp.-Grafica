...
//#endif
	...
	int nPoints = 20;
	//GLuint VAO = generateCircle(0.5, nPoints); //Circulo

	GLuint VAO = setupGeometry(); //Triangulo
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLES, 0, 3); //Triangulo
		//glDrawArrays(GL_TRIANGLE_FAN, 0, nPoints + 2); //Circulo

		// Chamada de desenho - drawcall
		// CONTORNO - GL_LINE_LOOP
		// PONTOS - GL_POINTS
		glUniform4f(colorLoc, 0.0f, 0.0f, 1.0f, 1.0f); //enviando cor para variável uniform inputColor
		glDrawArrays(GL_LINE_LOOP, 0, 3); //Triangulo
		//glDrawArrays(GL_LINE_LOOP, 0, nPoints + 2); //Circulo
